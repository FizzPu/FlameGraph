package org.mx.yahaha.toolchain.authentication.config;
...
import org.mx.yahaha.toolchain.authentication.support.AuthFilter;
...
public class ShiroWebConfiguration {
	...
	@Bean
	public WebServerAuthenticator requestAuthenticator() {
		WebServerAuthenticator authenticator = new WebServerAuthenticator();
		authenticator.addExcludePath(new WebServerAuthenticator.UrlEndPoint("/auth/login", RequestMethod.POST));
		return authenticator;
	}

	@Bean
	public FilterRegistrationBean<Filter> authFilter(WebServerAuthenticator requestAuthenticator) {
		FilterRegistrationBean<Filter> filterRegistrationBean = new FilterRegistrationBean<>();
